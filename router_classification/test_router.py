#!/usr/bin/env python3
"""
Evaluate classification-based router on ARC-C, TriviaQA, and IFEval test data.

Usage: python router_classification/test_router.py
"""
import argparse
import json
...
def main():
    ...
    parser.add_argument("--router_path", default="checkpoints/router_cls/final")
    parser.add_argument("--eval_data", default="router_classification/data/eval.jsonl")
    parser.add_argument("--out_dir", default="router_classification/results")
    ...
    for item in eval_data:
        # No prompt prefix - just use the question directly
    ...
    # Print results
    print("\n" + "="*60)
    print("Router Evaluation Results (Classification-based)")
    print("="*60)
    for task in sorted(results_by_task.keys()):
        stats = results_by_task[task]
