#!/usr/bin/env python3
"""
Evaluate rule-based router on ARC-C, TriviaQA, and IFEval test data.

Usage: python router_rules/test_router.py
"""
import argparse
import json
...
def main():
    ...
    parser.add_argument("--eval_data", default="router_rules/data/eval.jsonl")
    parser.add_argument("--out_dir", default="router_rules/results")
    args = parser.parse_args()

    print("Initializing rule-based router...")
    router = Router()
    ...
    # Print results
    print("\n" + "="*60)
    print("Router Evaluation Results (Rule-based)")
    print("="*60)
    for task in sorted(results_by_task.keys()):
        stats = results_by_task[task]
