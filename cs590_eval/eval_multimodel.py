...
def main():
    ap = argparse.ArgumentParser(description="Evaluate using MultiModelRouterPipeline with task-specific models")
    ...
    ap.add_argument("--out_dir", type=str, default="outputs_multimodel", help="Directory to save predictions and metrics")
    ...
    if args.skip_existing and os.path.exists(preds_path):
        ...
        # Generate predictions using MultiModelRouterPipeline
        print("Using MultiModelRouterPipeline with task-specific models from MODEL_MAP")
        pipeline = MultiModelRouterPipeline()
